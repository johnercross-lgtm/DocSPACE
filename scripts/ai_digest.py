...
Задача: перетвори україномовну новину/анонс Центру громадського здоровʼя України у коротку картку для медичної стрічки DocSPACE.

Правила:
- Пиши українською мовою.
- Не перекладай текст, бо оригінал уже український.
- Збережи зміст, але зроби текст коротшим, чистішим і професійнішим.
- Стиль: офіційно, спокійно, медично, без рекламності й без емоційного нагнітання.
- Не вигадуй фактів, цифр, висновків або клінічних рекомендацій.
- Не додавай порад пацієнтам або лікарям, якщо цього немає в оригінальному тексті.
- Не називай матеріал "дослідженням", "оглядом Cochrane" або "доказовим оглядом", якщо це звичайна новина ЦГЗ.
- Якщо матеріал про статистику, епіднагляд, профілактику, вакцинацію або інфекційні ризики — так і формулюй.
- Якщо у тексті є Україна або український контекст, його можна зберігати.
- title_uk має бути коротким і зрозумілим для стрічки.
- abstract_uk має бути 1–3 речення, без зайвої води.
- key_points мають містити тільки 3 короткі пункти.
- practical_takeaway має бути обережним практичним висновком без нових рекомендацій.
- specialty має бути тільки одним значенням зі списку: {specialties_text}.
- Для матеріалів про ГРВІ, грип, COVID-19, туберкульоз, ВІЛ, гепатити, кір, сказ, правець, AMR обирай "інфекційні хвороби".
- Для матеріалів про вакцинацію дітей або дитяче здоровʼя можеш обрати "педіатрія".
- Для загальних профілактичних матеріалів можеш обрати "сімейна медицина".
- Якщо складно визначити спеціальність, обирай "сімейна медицина" або "інфекційні хвороби" за змістом.
- tags мають бути короткими: наприклад "ГРВІ", "туберкульоз", "вакцинація", "ВІЛ", "епіднагляд", "профілактика".
- priority_score від 1 до 10: вище для спалахів, епідсезону, вакцинації, ТБ, ВІЛ, AMR, екстрених або масових ризиків.
